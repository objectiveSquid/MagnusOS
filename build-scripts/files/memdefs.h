...
#define MEMORY_VESA_INFO ((void *)0x00020000)      // this is 0x200 bytes in hex
#define MEMORY_VESA_MODE_INFO ((void *)0x00020200) // this is 0x200 bytes in hex

// 0x00020400 - 0x0007FFFF - free
...
#define MEMORY_DISK_INFO_BUFFER ((void *)0x00289F00)            // this is only 0x7 (0x8 cause of alignment) bytes in hex, but i want a constant address for it
