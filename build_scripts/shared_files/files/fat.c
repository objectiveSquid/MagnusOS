...
bool FAT_ReadFat(Partition *partition) {
    return Partition_ReadSectors(partition, g_Data->BS.bootSector.reservedSectors, g_Data->BS.bootSector.sectorsPerFat, g_Fat);
}
